...
# Need to symlink libgsl.so.27.0.0 (pre-installed) to libgsl.so.0 for AFNI.
...
&& ln -s /usr/lib/x86_64-linux-gnu/libgsl.so.27.0.0 /usr/lib/x86_64-linux-gnu/libgsl.so.0 \
